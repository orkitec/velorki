...
// System / Light / Dark, next to the locale switcher. The choice lives in the
// reader's own browser and is applied by `data-theme` on <html>, which
...
import { DEFAULT_THEME, THEMES, THEME_STORAGE_KEY, resolveTheme, themeAttribute, type Theme } from '@/site/theme';
...
export function ThemeSwitcher() {
  ...
  return (
    <div role="group" aria-label={t('label')} className="flex items-center rounded-full border border-line-soft p-0.5">
      {THEMES.map((value) => {
