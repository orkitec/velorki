...
Eine Route öffnet sich mit dem Rad, das ihre Datei nennt: ein GPX-`<type>` wie `road_biking` oder `mountain_biking`, oder die Untersportart einer FIT-Strecke oder -Aktivität (Straße, Mountainbike, Gravel), wird zu **Rennrad**, **MTB**, **Gravel** oder **Trekking**. Eine Datei, die keines nennt, öffnet sich mit dem Rad, mit dem du zuletzt gefahren bist. Eine exportierte Route schreibt ihr Rad auf dieselbe Weise zurück; TCX hat dafür kein Wort.
