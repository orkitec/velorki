...
Die Übersicht unter der Karte hat drei Seiten, einen Wisch auseinander, mit drei Punkten unter den Zahlen, die sagen, welche gerade oben ist. Eine neue Fahrt beginnt auf den Zahlen. Vor einer Fahrt faltet sich die Übersicht, ganz nach unten gezogen, in die Navigationsleiste und lässt nur ihren Griff über den Tabs, damit die Karte frei ist; zieh den Griff nach oben, um sie zurückzuholen. Während einer Fahrt ist die Leiste weg, und die Übersicht sinkt bis zu ihrem Griff am unteren Bildschirmrand.
