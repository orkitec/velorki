...
void main() {
  testWidgets('both switches start on', (tester) async {
    await _pump(tester);
  ...
  testWidgets('switching the turns off persists and greys out the voice', (
    tester,
  ) async {
  ...
  testWidgets('the stored switches are the ones shown', (tester) async {
    await _pump(
      tester,
      initial: const <String, Object>{'navigation.voice': false},
    );
