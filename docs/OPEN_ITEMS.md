...
- [ ] **Oracle tile release** (blocks a green CI): create `oracle-20260912` in `orkitec/velorki-data` with the recorded W20_N30/W25_N60 tiles and push the prune fix — staged in the session scratchpad as `publish-oracle-tiles.sh`; see tools/brouter-oracle/README.md.
